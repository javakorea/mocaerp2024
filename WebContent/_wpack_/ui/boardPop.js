...
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',A:{},E:[{T:1,N:'w2:buildDate'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataMap',A:{baseNode:'map',id:'dma_search'},E:[{T:1,N:'w2:keyInfo',E:[{T:1,N:'w2:key',A:{id:'BOARD_IDX',name:'게시물번호',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_PIDX',name:'게시물부모번호',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_DATE',name:'작성일시',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_WRITER',name:'작성자',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_TITLE',name:'제목',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_TYPE',name:'게시판유형',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_FILE_TABLE',name:'게시판첨부파일테이블',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_TABLE',name:'게시판테이블',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_CONT',name:'게시물컨텐츠',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_DELYN',name:'삭제여부',dataType:'text'}},{T:1,N:'w2:key',A:{id:'STATUS',name:'상태',dataType:'text'}},{T:1,N:'w2:key',A:{id:'QUERY',name:'QUERY',dataType:'text'}}]}]},{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'dlt_boardFile',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'BOARDFILE_IDX',name:'BOARDFILE_IDX',dataType:'text'}},{T:1,N:'w2:column',A:{id:'BOARD_IDX',name:'BOARD_IDX',dataType:'text'}},{T:1,N:'w2:column',A:{id:'BOARDFILE_NAME',name:'BOARDFILE_NAME',dataType:'text'}},{T:1,N:'w2:column',A:{id:'BOARDFILE_NAMESERVER',name:'BOARDFILE_NAMESERVER',dataType:'text'}},{T:1,N:'w2:column',A:{id:'BOARDFILE_PATH',name:'BOARDFILE_PATH',dataType:'text'}},{T:1,N:'w2:column',A:{id:'BOARDFILE_SIZE',name:'BOARDFILE_SIZE',dataType:'text'}},{T:1,N:'w2:column',A:{id:'BOARDFILE_ID',name:'BOARDFILE_ID',dataType:'text'}},{T:1,N:'w2:column',A:{id:'THUMBNAIL',name:'THUMBNAIL',dataType:'text'}}]}]},{T:1,N:'w2:dataMap',A:{baseNode:'map',id:'dma_map'},E:[{T:1,N:'w2:keyInfo',E:[{T:1,N:'w2:key',A:{id:'BOARD_IDX',name:'BOARD_IDX',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_TITLE',name:'BOARD_TITLE',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_CONT',name:'BOARD_CONT',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_WRITER',name:'BOARD_WRITER',dataType:'text'}},{T:1,N:'w2:key',A:{id:'BOARD_DATE',name:'BOARD_DATE',dataType:'text'}}]}]}]},{T:1,N:'w2:workflowCollection'},{T:1,N:'xf:submission',A:{id:'sbm_boardFileList',ref:'data:json,dma_search',target:'data:json,{"id":"dlt_boardFile","key":"dlt_list"}',action:'/selectList.do',method:'post',mediatype:'application/json',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_boardFileList_submitdone','ev:submiterror':'',abortTrigger:''}},{T:1,N:'xf:submission',A:{id:'sbm_boardInfo',ref:'data:json,dma_search',target:'data:json,dma_map',action:'/selectMap.do',method:'post',mediatype:'application/json',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_searchBoardInfo_submitdone','ev:submiterror':'',abortTrigger:''}},{T:1,N:'xf:submission',A:{id:'sbm_insertBoardInfo',ref:'data:json,dma_search',target:'data:json,dma_map',action:'/insertBoardInfo.do',method:'post',mediatype:'application/json',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_insertBoardInfo_submitdone','ev:submiterror':'',abortTrigger:''}},{T:1,N:'xf:submission',A:{id:'sbm_updateBoardInfo',ref:'data:json,dma_search',target:'data:json,dma_map',action:'/updateBoardInfo.do',method:'post',mediatype:'application/json',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_updateBoardInfo_submitdone','ev:submiterror':'',abortTrigger:''}}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{type:'text/javascript',lazy:'false'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){scwin.onpageload = function () {
    ...
    var googleLoginURL2 = 'https://accounts.google.com/gsi/client';
    var googleLoginScript2 = document.createElement('script');
    googleLoginScript2.setAttribute('src', googleLoginURL2);
    googleLoginScript2.onload = function (e) {
        gisLoaded();
    };
    document.body.insertBefore(googleLoginScript2, document.body.firstChild);
};
scwin.fn_searchBoardInfo = function () {
    dma_search.set('QUERY', 'M.selectBoardInfo');
    com.sbm.execute($p, sbm_boardInfo);
    scwin.sbm_searchBoardInfo_submitdone = function (e) {
        edi_1.setHTML(dma_map.get('BOARD_CONT'));
        scwin.fn_searchFile();
    };
};
scwin.fn_searchFile = function () {
    dma_search.set('QUERY', 'M.selectBoardFileList');
...
scwin.grd_program_oncelldblclick = async function (row, col, colId) {
    let _id = dlt_boardFile.getCellData(row, 'BOARDFILE_NAMESERVER');
    handleAuthClick(_id);
};
...
scwin.thumbnail = _id => {
    return '<img src=\'https://drive.google.com/thumbnail?sz=s24&id=' + _id + '\'/>';
};
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{id:'',class:'pop_contents flex_gvw  flex_m'},E:[{T:1,N:'xf:group',A:{id:''},E:[{T:1,N:'xf:group',A:{style:'',id:'dfbox',class:'dfbox'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'fr'},E:[{T:1,N:'xf:trigger',A:{style:'display:none;',id:'btn_del',type:'button',class:'btn_cm','ev:onclick':'scwin.btn_del_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'삭제'}]}]},{T:1,N:'xf:trigger',A:{style:'display:none;',id:'btn_adminDel',type:'button',class:'btn_cm red','ev:onclick':'scwin.btn_adminDel_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'폐기'}]}]},{T:1,N:'xf:trigger',A:{class:'btn_cm','ev:onclick':'scwin.btn_confirm_onclick',id:'btn_confirm',nextTabID:'',style:'',type:'button'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'저장'}]}]},{T:1,N:'xf:trigger',A:{class:'btn_cm',id:'btn_update',nextTabID:'',style:'display:none;',type:'button','ev:onclick':'scwin.btn_update_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'수정'}]}]},{T:1,N:'xf:trigger',A:{class:'btn_cm','ev:onclick':'scwin.btn_cancel_onclick',id:'btn_cancel',style:'',type:'button'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'취소'}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'tbbox',id:'tbl_search',style:''},E:[{T:1,N:'xf:group',A:{adaptive:'layout',adaptiveThreshold:'768',class:'w2tb tb',id:'',style:'width:100%;',tagname:'table'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{tagname:'col'}}]},{T:1,N:'xf:group',A:{style:'display:none;',tagname:'tr',id:'tr_read'},E:[{T:1,N:'xf:group',A:{tagname:'td',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:input',A:{class:'',id:'ibx_boardIdx',placeholder:'',style:'width:100%;',ref:'data:dma_search.BOARD_IDX',readOnly:'true'}}]}]},{T:1,N:'xf:group',A:{tagname:'tr'},E:[{T:1,N:'xf:group',A:{tagname:'td',class:'w2tb_td',style:'padding: 4px; border:1px solid  #ced4da;'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:input',A:{class:'',id:'ibx_boardTitle',placeholder:'',ref:'data:dma_search.BOARD_TITLE',style:'width:100%;'}}]}]},{T:1,N:'xf:group',A:{tagname:'tr',id:'tr_read2',style:'display:none;'},E:[{T:1,N:'xf:group',A:{tagname:'td',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:input',A:{class:'',id:'ibx_boardDate',placeholder:'',readOnly:'true',ref:'data:dma_search.BOARD_DATE',style:'width:100%;'}}]}]},{T:1,N:'xf:group',A:{tagname:'tr',id:'tr_read3',style:'display:none'},E:[{T:1,N:'xf:group',A:{tagname:'td',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:input',A:{class:'',id:'ibx_boardWriter',placeholder:'',readOnly:'true',ref:'data:dma_search.BOARD_WRITER',style:'width:100%;'}}]}]}]}]},{T:1,N:'xf:group',A:{id:'',class:'edbox',style:'margin-bottom: 16px;'},E:[{T:1,N:'w2:editor',A:{style:'',id:'edi_1',menubar:'board','ev:onload':'scwin.edi_1_onload'}}]},{T:1,N:'xf:group',A:{class:'dfbox',id:'',style:''},E:[{T:1,N:'w2:textbox',A:{class:'',id:'',label:'첨부파일',style:'',tagname:'h3'}},{T:1,N:'xf:group',A:{class:'fr',id:'',style:''},E:[{T:1,N:'w2:textbox',A:{class:'',id:'txt_cnt',label:'0건',style:''}},{T:1,N:'xf:trigger',A:{class:'btn_cm',id:'btn_fileUpload',style:'',type:'button'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'파일찾기'}]}]}]}]},{T:1,N:'xf:group',A:{adaptiveThreshold:'',class:'gvwbox wq_flx',id:'',style:''},E:[{T:1,N:'w2:gridView',A:{autoFit:'lastColumn',captionTitle:'',checkReadOnlyOnCut:'',class:'wq_gvw',dataList:'data:dlt_boardFile',defaultCellHeight:'26',id:'grd_program',rowStatusHeaderValue:'상태',rowStatusVisible:'false',rowStatusWidth:'',scrollByColumn:'false',scrollByColumnAdaptive:'false',style:'min-height:80px;max-height:80px;','ev:onrowindexchange':'scwin.grd_program_onrowindexchange','ev:oncelldblclick':'scwin.grd_program_oncelldblclick',focusMode:'row',visibleRowNum:'2',rowNumVisible:'true'},E:[{T:1,N:'w2:caption',A:{id:'caption1',style:'',value:'this is a grid caption.'}},{T:1,N:'w2:header',A:{id:'header1',style:''},E:[{T:1,N:'w2:row',A:{id:'row1',style:''},E:[{T:1,N:'w2:column',A:{blockSelect:'false',class:'',displayMode:'label',id:'column17',inputType:'text',removeBorderStyle:'false',style:'',value:'IDX',width:'50'}},{T:1,N:'w2:column',A:{width:'26',inputType:'text',style:'',id:'column53',value:'',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'60',inputType:'text',style:'',id:'column52',value:'파일크기',displayMode:'label'}},{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',id:'column16',inputType:'text',removeBorderStyle:'false',style:'',value:'파일명',width:'200'}}]}]},{T:1,N:'w2:gBody',A:{id:'gBody1',style:''},E:[{T:1,N:'w2:row',A:{id:'row2',style:''},E:[{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',id:'BOARDFILE_IDX',inputType:'text',removeBorderStyle:'false',style:'',value:'',width:'50',readOnly:'true',minWidth:'0'}},{T:1,N:'w2:column',A:{width:'26',inputType:'text',style:'',id:'BOARDFILE_NAMESERVER',value:'',displayMode:'label',displayFormatter:'scwin.thumbnail'}},{T:1,N:'w2:column',A:{width:'60',inputType:'text',style:'',id:'BOARDFILE_SIZE',value:'',displayMode:'label',displayFormatter:'scwin.fn_bytesToLabel',textAlign:'right'}},{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',id:'BOARDFILE_NAME',inputType:'text',removeBorderStyle:'false',style:'',value:'',width:'200',readOnly:'true',textAlign:'left'}}]}]}]}]}]}]}]}]})