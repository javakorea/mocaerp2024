/*amd /ui/schedulePop.xml 9793 0fa995e8ed6d73cf7bdbb228e0599a450dab6b0badc6e8e82ecbeb7a8c4841a3 */
...
scwin.btn_confirm_onclick = function (e) {
    com.win.confirm($p, '일정을 등록하시겠습니까?', function (e) {
        if (e.clickValue) {
            ...
            dma_schdInfo.set('SCH_COLOR', '#FF836D');
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{id:'',class:'pop_contents flex_gvw'},E:[{T:1,N:'xf:group',A:{id:''},E:[{T:1,N:'xf:group',A:{style:'display:none;',id:'dfbox',class:'dfbox'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'fr'},E:[{T:1,N:'xf:trigger',A:{style:'',id:'btn_del',type:'button',class:'btn_cm  row_del','ev:onclick':'scwin.btn_del_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'삭제'}]}]},{T:1,N:'xf:trigger',A:{style:'',id:'btn_adminDel',type:'button',class:'btn_cm row_del','ev:onclick':'scwin.btn_adminDel_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'물리삭제'}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'tbbox',id:'tbl_search',style:''},E:[{T:1,N:'xf:group',A:{adaptive:'layout',adaptiveThreshold:'768',class:'w2tb tb',id:'',style:'width:100%;',tagname:'table'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{tagname:'col',style:'width:80px;'}},{T:1,N:'xf:group',A:{tagname:'col',style:''}}]},{T:1,N:'xf:group',A:{style:'',tagname:'tr',id:'tr_read'},E:[{T:1,N:'xf:group',A:{tagname:'th',class:'w2tb_th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'일정기간',style:''}}]},{T:1,N:'xf:group',A:{tagname:'td',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonthDateTimeSec',focusOnDateSelect:'false',footerDiv:'true',id:'',ref:'data:dma_schdInfo.SCH_START',renderDiv:'true',rightAlign:'false',style:'width:calc(50% - 5px);width:calc(50% - 2.5px);',class:'multi'}},{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonthDateTimeSec',focusOnDateSelect:'false',footerDiv:'true',id:'',ref:'data:dma_schdInfo.SCH_END',renderDiv:'true',rightAlign:'false',style:'width:calc(50% - 2.5px);margin-right:0;',class:'multi'}}]}]},{T:1,N:'xf:group',A:{tagname:'tr',id:'tr_createDt',style:'display:none;'},E:[{T:1,N:'xf:group',A:{tagname:'th',class:'w2tb_th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'작성일시',style:''}}]},{T:1,N:'xf:group',A:{tagname:'td',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:input',A:{class:'',id:'ibx_schdDate',placeholder:'',readOnly:'true',ref:'data:dma_schdInfo.SCH_CREATE_DTTM',style:'width:100%;'}}]}]},{T:1,N:'xf:group',A:{tagname:'tr',style:'display:none;',id:'tr_writer'},E:[{T:1,N:'xf:group',A:{tagname:'th',class:'w2tb_th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'작성자',style:''}}]},{T:1,N:'xf:group',A:{tagname:'td',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:input',A:{class:'',id:'ibx_schdWriter',placeholder:'',readOnly:'true',ref:'data:dma_schdInfo.SCH_WRITER',style:'width:100%;'}}]}]},{T:1,N:'xf:group',A:{tagname:'tr'},E:[{T:1,N:'xf:group',A:{tagname:'th',class:'w2tb_th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'제목',style:''}}]},{T:1,N:'xf:group',A:{tagname:'td',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:input',A:{class:'req',id:'ibx_boardTitle',placeholder:'',ref:'data:dma_schdInfo.SCH_TITLE',style:'width:100%;'}}]}]}]}]},{T:1,N:'xf:group',A:{id:'',class:'edbox'},E:[{T:1,N:'w2:editor',A:{style:'height:200px;',id:'edi_1',menubar:'onlyTxt'}}]},{T:1,N:'xf:group',A:{class:'btnbox',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'fr',id:''},E:[{T:1,N:'xf:trigger',A:{class:'btn_cm pt',id:'btn_update',nextTabID:'',style:'display:none;',type:'button','ev:onclick':'scwin.btn_update_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'수정'}]}]},{T:1,N:'xf:trigger',A:{class:'btn_cm pt',id:'btn_confirm',style:'',type:'button',nextTabID:'','ev:onclick':'scwin.btn_confirm_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'등록'}]}]},{T:1,N:'xf:trigger',A:{class:'btn_cm',id:'btn_cancel',style:'',type:'button','ev:onclick':'scwin.btn_cancel_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'취소'}]}]}]}]}]}]}]}]})