/*amd /ui/schedulePop.xml 9372 c8c5e142553e0db1ff58130564f7718ac28bdab84fca7f9ebf0ed9f927b3489a */
...
scwin.fn_searchScheduleInfo = function () {
    ...
    scwin.sbm_schdInfo_submitdone = function (e) {
        $('#wcolor')[0].value = dma_schdInfo.get('SCH_COLOR');
...
scwin.btn_confirm_onclick = function (e) {
    com.win.confirm($p, '일정을 등록하시겠습니까?', function (e) {
        if (e.clickValue) {
            ...
            dma_schdInfo.set('SCH_COLOR', $('#wcolor')[0].value);
