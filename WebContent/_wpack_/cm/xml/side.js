...
scwin.trv_menu_onclick = function () {
    if (trv_menu.isLeaf()) {
        ...
        if (selectedMenu.length > 0) {
            ...
            var _param = {
                'boardType': selectedMenu[0].TYPE,
                'erpYn': selectedMenu[0].ERP_YN
            };
            scwin.setMenuRelation(tLabel, tURL, tCode, 'Tree', _param);
        }
    }
};
...
scwin.setMenuRelation = function (menuNm, menuUrl, menuCode, skipType, param, option) {
    ...
    if (menuList && menuList.length > 0) {
        ...
        if (com.win.openMenu($p, menuNm, menuUrl, menuCode, param, option)) {
            scwin.addHistory(menuNm, menuUrl, menuCode, null);
        }
